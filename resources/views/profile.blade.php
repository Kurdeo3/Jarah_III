...
<body class="font-sans bg-white text-gray-900">
                ...
                <div class="flex items-start space-x-6">
                    <div>
                        <div class="flex items-center space-x-4 mb-5">
                            <!-- Icon Box -->
                            <div class="w-20 h-20 bg-[#008000] rounded-lg flex items-center justify-center">
    ...
    <section class="pb-14 md:px-8 bg-gray-100">
    <h1 class="text-4xl font-bold text-center mb-6 text-[#005f2f]">GALERI DESA</h1>
        <div class="max-w-6xl mx-auto relative">
            <!-- Tombol Navigasi -->
            <button id="galeriPrev"
                class="absolute left-0 top-1/2 z-10 -translate-y-1/2 bg-white text-[#006400] p-2 rounded-full shadow">
                &#8592;
            </button>
            <button id="galeriNext"
                class="absolute right-0 top-1/2 z-10 -translate-y-1/2 bg-white text-[#006400] p-2 rounded-full shadow">
                &#8594;
            </button>
            <!-- Container Slide -->
            <div class="overflow-hidden">
                <div id="galeriSlider" class="flex transition-transform duration-500 ease-in-out">
                    ...
                    <div class="w-1/4 flex-shrink-0 px-1">
    ...
    <section class="py-16 px-4 md:px-8 bg-[rgba(0,128,0,0.65)] text-white">
        <div class="max-w-6xl mx-auto">
            <div class="grid md:grid-cols-1 gap-12">
                ...
                <div class="bg-white/95 backdrop-blur-sm rounded-2xl p-8 shadow-xl">
                    <div class="flex items-start space-x-4 mb-6">
                        ...
                        <div>
                            <h3 class="text-3xl font-bold text-black mt-3">VISI JARAH III</h3>
                        </div>
                    </div>
                ...
                <div class="bg-white/95 backdrop-blur-sm rounded-2xl p-8 shadow-xl">
                    <div class="flex items-start space-x-4 mb-6">
                        ...
                        <div>
                            <h3 class="text-3xl font-bold text-black mt-3">MISI JARAH III</h3>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const totalSlides = {{ count($galeris) }};
            let currentIndex = 0;
