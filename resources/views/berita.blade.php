...
<body class="font-sans bg-white text-gray-900">
    ...
    <!-- Hero Section -->
    <section class="relative h-[400px] bg-cover bg-center" style="background-image: url('storage/Assets/berita_wallpaper3.jpg');">
    ...
    <section class="py-16 px-4 md:px-8 bg-gray-100 min-h-screen">
            ...
            @foreach($beritas as $berita)
                <div class="bg-white rounded-xl shadow-md flex flex-col md:flex-row overflow-hidden mb-8">
                    ...
                    <div class="md:w-2/3 w-full p-6 flex flex-col justify-between">
                        ...
                        <h3 class="text-lg md:text-xl font-bold text-black leading-snug mb-3 line-clamp-2">
                            {{ $berita->judul_berita }}
                        </h3>
                        ...
                        <div class="flex justify-end mt-2">
                            <button type="button" 
                                ...
                                <a href="{{ route('showBeritaDetailPage', $berita->id) }}">Baca selengkapnya -></a>
                            </button>
                        </div>
                    </div>
